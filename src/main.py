...
class TrainingArgs:
    ...
    layer_drop: float = 0.0  # TODO: layer-drop is not implemented correctly
    ...
    train_dir: str = "../data/dev"
    val_dir: str = "../data/dev"
    test_dir: str = "../data/dev"
...
def main(args):
    ...
    with strategy.scope():
        ...
        loss_fn = CTCLoss(model.config, input_shape, division_factor=global_batch_size)
